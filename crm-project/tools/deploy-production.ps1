...
$environmentVariables = "^|^NODE_ENV=production|MALWARE_SCAN_REQUIRED=true|TRUST_PROXY=1|APP_NAME=Talent Acquisition|APP_LOGIN_URL=$AppLoginUrl|FIREBASE_ENVIRONMENT=production|FIREBASE_PROD_PROJECT_ID=$projectId|FIREBASE_PROD_STORAGE_BUCKET=$storageBucket|FIREBASE_FIRESTORE_DATABASE_ID=default|CORS_ALLOWED_ORIGINS=$CorsAllowedOrigins|SMTP_PORT=$SmtpPort|SMTP_SECURE=$SmtpSecure"
